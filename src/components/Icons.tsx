...
export const IconLike: Component<{style: string}> = ({style}) => {
    return (
        <svg id="_레이어_3" data-name="레이어 3" xmlns="http://www.w3.org/2000/svg"
            height="40"
            width="40"
            viewBox="0 0 160 160"
            class={`${style} ${mainSys.isFilterOn()? 'fill-sub' : 'fill-plain'}`}
            onClick={() => mainSys.setIsFilterOn((prev: boolean) => !prev)}
            cursor="pointer">
...
export const IconSearch: Component<{style: string}> = ({style}) => {
    return (
...
export const IconLogout: Component = () => {
    return (
        <svg id="_레이어_3" data-name="레이어 3" xmlns="http://www.w3.org/2000/svg"
            ...
            class="fill-plain"
            cursor="pointer"
            onClick={() => accountSys.logoutHandler()}
            >
